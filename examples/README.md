...
- **`ci.yml`** - Continuous integration workflow
  ...
  - Uses: `CLDMV/.github/.github/workflows/workflow-ci.yml@v3`
...
- **`release.yml`** - Release PR creation workflow
  ...
  - Uses: `CLDMV/.github/.github/workflows/workflow-release.yml@v3`
...
- **`publish.yml`** - Package publishing and release creation workflow
  ...
  - Uses: `CLDMV/.github/.github/workflows/workflow-publish.yml@v3`
...
- **`docker-publish.yml`** - Docker image build and GHCR publish workflow
  ...
  - Uses: `CLDMV/.github/.github/workflows/workflow-docker-publish.yml@v3`
...
- **`update-major-version-tags.yml`** - Floating version tag maintenance workflow
  ...
  - Uses: `CLDMV/.github/.github/workflows/workflow-update-major-version-tags.yml@v3`
