...
/**
 * Generalized Summary Generator
 * Iterates through job summary data and generates detailed GitHub Step Summary
 * Also handles GitHub outputs and statistics calculation
 */

import { writeFileSync } from "fs";

// Get environment variables
const repository = process.env.REPO_NAME || process.env.GITHUB_REPOSITORY || "unknown/repo";
