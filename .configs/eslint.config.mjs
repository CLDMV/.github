...
export default defineConfig([
	...
	// docs/tools/ruleset-generator/generator.js is a browser ES module loaded via
	// <script type="module"> (see its index.html) — override the fleet default
	// that treats *.js as CommonJS. Not a rule relaxation; it states the real type.
	{ files: ["docs/tools/ruleset-generator/generator.js"], languageOptions: { sourceType: "module" } },
